...
import { CircleDollarSign, FilesIcon, LayoutDashboard, ListChecks } from "lucide-react";
    ...
    <>
      {
        !course.isPublished && (
          <Banner
            variant={"warning"}
            label="This course is not published yet and will not be visible to students."
          />
        )
      }
      <div className="p-6">
